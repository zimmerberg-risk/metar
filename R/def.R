...
metar.vars <- list(
  ...
  ff = list(name = "Wind Speed", type = "integer", drop = F, min = 0, max = 100),
  fx = list(name = "Wind Gusts", type = "integer", drop = F, min = 0, max = 100),
